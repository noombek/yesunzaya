              ...
              _createClass(SimpleLightbox, [
                ...
                },
                {
                  ...
                  value: function getCaptionElement(elem) {
                    ...
                    if (this.options.captionSelector.startsWith("+")) {
                      var selector = this.options.captionSelector
                        .replace(/^\+/, "")
                        .trimStart();
                      ...
                      var _selector = this.options.captionSelector
                        .replace(/^>/, "")
                        .trimStart();
                ...
                },
                {
                  ...
                  value: function generateQuerySelector(elem) {
                    ...
                    return ""
                      .concat(this.generateQuerySelector(parentNode), " > ")
                      .concat(str);
                  },
                },
                {
                  ...
                  value: function createDomNodes() {
                    ...
                    if (this.options.captionClass) {
                      ...
                      var captionClasses =
                        this.options.captionClass.split(/[\s,]+/);
                      (_this$domNodes$captio =
                        this.domNodes.caption.classList).add.apply(
                        _this$domNodes$captio,
                        _toConsumableArray(captionClasses)
                      );
                    }
                    ...
                    return (
                      ...
                      (element.getAttribute(this.options.sourceAttr) &&
                        new RegExp(
                          "(" + this.options.fileExt + ")($|\\?.*$)",
                          "i"
                        ).test(element.getAttribute(this.options.sourceAttr)))
                    );
                  },
                },
                {
                      ...
                      function (event) {
                        ...
                        if (event.type === "mousedown") {
                          ...
                          if (_this6.controlCoordinates.touchCount === 1) {
                            /* Single touch */ if (
                              !_this6.controlCoordinates.doubleTapped
                            ) {
                ...
                },
                {
                  ...
                  value: function setCaption(
                    ...
                    if (
                      ...
                      var property = (
                        (_ref =
                          allowHTML !== null && allowHTML !== void 0
                            ? allowHTML
                            : this.options.captionHTML) !== null &&
                        _ref !== void 0
                          ? _ref
                          : true
                      )
                      ...
                      this.domNodes.caption.style.width = imageWidth;
