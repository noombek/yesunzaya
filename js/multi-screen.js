...
var MultiScreen = (function () {
  ...
  var init = function (options) {
    ...
    if (ms_screens.length > 1) {
      ...
      if (default_screen.length === 0) {
        ...
        $("div.ms-container.ms-default")
          .not("div.ms-container.ms-default:first")
          .toggleClass("ms-default");
      }
  ...
  var switch_screens = function (options) {
    ...
    if (lock_navigation === false) {
      ...
      var target =
          typeof options === "object" && typeof options.target_id === "string"
            ? get_target_screen(options.target_id)
            : false,
      ...
      if (target !== false && target[0] !== current[0]) {
        ...
        options.exit_animation_command =
          typeof options.exit_animation_command === "undefined"
            ? options.animation_command
            : options.exit_animation_command;
        options.enter_animation_command =
          typeof options.enter_animation_command === "undefined"
            ? options.animation_command
            : options.enter_animation_command;

        options.exit_animation_time =
          typeof options.exit_animation_time === "undefined"
            ? options.animation_time
            : options.exit_animation_time;
        options.enter_animation_time =
          typeof options.enter_animation_time === "undefined"
            ? options.animation_time
            : options.enter_animation_time;

        options.vertical_distance =
          typeof options.vertical_distance === "undefined"
            ? options.distance
            : options.vertical_distance;
        options.horizontal_distance =
          typeof options.horizontal_distance === "undefined"
            ? options.distance
            : options.horizontal_distance;
        ...
        if ($(document).scrollTop() > 0) {
          ...
          $("body").animate(
            { scrollTop: 0 },
            get_switch_time(options.scroll_time, "scroll"),
            function () {
  ...
  var run_animation = function (
    ...
    enter_str = check_animation_command(enter_str)
      ? enter_str
      : get_default_animation("enter");
    exit_str = check_animation_command(exit_str)
      ? exit_str
      : get_default_animation("exit");
    ...
    var target_css = get_target_css(
        movement.enter.x,
        movement.enter.y,
        enter_fade
      ),
      current_css = get_current_css(
        movement.exit.x,
        movement.exit.y,
        exit_fade
      );
    ...
    if (typeof delay !== "boolean") {
      delay =
        typeof delay !== "string" ||
        (delay.toLowerCase() !== "true" && delay.toLowerCase() !== "false")
          ? get_default_delay()
          : delay.toLowerCase() === "true";
    }
  ...
  var animate_current = function (
    ...
    current
      .css(current_css.pre_css)
      .animate(
        current_css.animate_css,
        get_switch_time(exit_time_str, "exit"),
        function () {
  ...
  var animate_target = function (target, target_css, enter_time_str) {
    // apply pre_css, animate with animate_css and the input time
    target
      .css(target_css.pre_css)
      .animate(
        target_css.animate_css,
        get_switch_time(enter_time_str, "enter"),
        function () {
  ...
  var get_movement = function (
    ...
    vertical_buffer = check_int(vertical_buffer)
      ? parseInt(vertical_buffer)
      : get_default_distance_buffer("x");
    horizontal_buffer = check_int(horizontal_buffer)
      ? parseInt(horizontal_buffer)
      : get_default_distance_buffer("y");

    // if the screen is entering anywhere from the left, the target width is relevant
    if (
      enter_str === "topleft" ||
      enter_str === "left" ||
      enter_str === "bottomleft"
    ) {
      var x_movement =
        Math.max(target_width, $(window).width()) + horizontal_buffer;
    } else {
      var x_movement =
        Math.max(current_width, $(window).width()) + horizontal_buffer;
    }
    ...
    if (
      ...
      var y_movement =
        Math.max(target_height, $(window).height()) + vertical_buffer;
    } else {
      var y_movement =
        Math.max(current_height, $(window).height()) + vertical_buffer;
    }
  ...
  var get_default_distance_buffer = function (dimension) {
    ...
    if (!check_int(default_buffer)) {
      ...
      set_default_distance(
        default_buffer,
        dimension === "x" ? "horizontal" : "vertical"
      );
    }
  ...
  var set_defaults = function (options) {
    ...
    if (typeof options !== "undefined") {
      ...
      if (typeof options.default_time !== "undefined") {
        check_bool = !set_default_time(options.default_time)
          ? false
          : check_bool;
      }
      ...
      if (typeof options.default_enter_time !== "undefined") {
        check_bool = !set_default_time(options.default_enter_time, "enter")
          ? false
          : check_bool;
      }
      ...
      if (typeof options.default_exit_time !== "undefined") {
        check_bool = !set_default_time(options.default_exit_time, "exit")
          ? false
          : check_bool;
      }
      ...
      if (typeof options.default_scroll_time !== "undefined") {
        check_bool = !set_default_time(options.default_scroll_time, "scroll")
          ? false
          : check_bool;
      }
      ...
      if (typeof options.default_animation !== "undefined") {
        check_bool = !set_default_animation(options.default_animation)
          ? false
          : check_bool;
      }
      ...
      if (typeof options.default_enter_animation !== "undefined") {
        check_bool = !set_default_animation(
          options.default_enter_animation,
          "enter"
        )
          ? false
          : check_bool;
      ...
      if (typeof options.default_exit_animation !== "undefined") {
        check_bool = !set_default_animation(
          options.default_exit_animation,
          "exit"
        )
          ? false
          : check_bool;
      ...
      if (typeof options.default_delay !== "undefined") {
        check_bool = !set_default_delay(options.default_delay)
          ? false
          : check_bool;
      }
      ...
      if (typeof options.default_distance !== "undefined") {
        check_bool = !set_default_distance(options.default_distance)
          ? false
          : check_bool;
      }
      ...
      if (typeof options.default_vertical_distance !== "undefined") {
        check_bool = !set_default_distance(
          options.default_vertical_distance,
          "vertical"
        )
          ? false
          : check_bool;
